            ...
            <div class="bg-white p-6 md:p-8 rounded-2xl border border-gray-200 shadow-sm space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="salary_range" id="salary_range" class="form-input text-xs" placeholder="e.g. KES 20,000 - 30,000">
                    </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="5" class="form-input text-xs" placeholder="Outline the job description (Accepts HTML)..." required></textarea>
                    </div>

                    <div>
                        <label for="requirements" class="form-label">Requirements <span class="text-red-500">*</span></label>
                        <textarea name="requirements" id="requirements" rows="4" class="form-input text-xs" placeholder="List the requirements (one per line, accepts HTML)..." required></textarea>
                    </div>

                    <div>
                        <label for="responsibilities" class="form-label">Responsibilities <span class="text-red-500">*</span></label>
                        <textarea name="responsibilities" id="responsibilities" rows="4" class="form-input text-xs" placeholder="List the responsibilities (one per line, accepts HTML)..." required></textarea>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#F7F8FA] p-4 rounded-xl border border-gray-200">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="requires_cv" value="1" class="sr-only peer" checked>
